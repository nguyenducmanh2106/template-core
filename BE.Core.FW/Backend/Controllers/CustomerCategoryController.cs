...
namespace Backend.Controllers
{
    ...
    {
        private readonly ICustomerCategoryHandler _handler;

        public CustomerCategoryController(ICustomerCategoryHandler handler)
        {
            _handler = handler;
        }

        [HttpPost]
        public ResponseData Create([FromBody] CustomerCategoryModel model)
        {
