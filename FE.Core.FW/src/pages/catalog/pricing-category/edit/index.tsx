...
function PricingCategoryEdit() {
    ...
    useEffect(() => {
        const fnGetInitState = async () => {
            setLoading(true);
            const responseRecordEdit: ResponseData = await getPricingCategory1(params.id);
    ...
    const handleOk = async () => {
        ...
        const response = await putPricingCategory(params.id, "", objBody);
        setButtonOkText('Lưu');
                ...
                title={
                    <>
                        <Space className="title">
                            ...
                            <Text strong>Cập nhật quy định giá</Text>
                        </Space>
                    </>
                }
                extra={
                ...
                {loading ? <Spin /> :
                    <Form
                        ...
                        initialValues={{
                            ...
                            ["ProductId"]: state.recordEdit?.productId,
                            ["PricingDecisionId"]: state.recordEdit?.pricingDecisionId,
