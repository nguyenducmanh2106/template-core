...
import { postContractType } from '@/apis/services/ContractTypeService';
...
function ContractTypeCreate() {
    ...
    const handleOk = async () => {
        ...
        const response = await postContractType("", objBody);
        setButtonOkText('Lưu');
                ...
                title={
                    <>
                        <Space className="title">
                            ...
                            <Text strong>Thêm mới loại HĐ</Text>
                        </Space>
                    </>
                }
                extra={
                    <Space>
                        <Button type="default" onClick={() => navigate('/catalog/contract-type')}>
                            Hủy bỏ
                        </Button>
