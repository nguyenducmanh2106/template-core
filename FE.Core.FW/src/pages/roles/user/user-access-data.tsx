...
const UserDataAcess: React.FC<Props> = ({ open, setOpen, reload, userEdit, initLoadingModal }) => {
    ...
    return (
        <>
            ...
            <Modal title={
                <>
                    <Text strong>Phân quyền truy cập dữ liệu cho người dùng</Text>
                </>
