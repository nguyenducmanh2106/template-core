...
function ImportRegistrationCode({ temp, open, setOpen, reload }: Props) {
    ...
    const handleOk = async () => {
        ...
        const obj = {
            ...
            IsOverwrite: fieldsValue.IsOverwrite,
            File: file
        }
        console.log(obj);
        // return;
        const response = await postRegistrationCode1(obj);
    ...
    const downloadFileTemplate = async () => {
        ...
        const response = await getFile(TemplateType._2);
        if (response.code === Code._200) {
    ...
    return (
        <>
            <Modal title="Import Code thi vòng 1" open={open} cancelText="Bỏ qua" width={'800px'}
...
export default ImportRegistrationCode;
