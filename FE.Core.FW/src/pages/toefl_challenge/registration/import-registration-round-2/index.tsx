...
function ImportRegistrationRound2({ temp, open, setOpen, reload }: Props) {
    ...
    const handleOk = async () => {
        ...
        console.log(obj);
        // return;
        const response = await postRegistration2(obj);
        if (response.code === Code._200) {
            message.success(response.message || "Upload danh sách đăng ký vòng 2 thành công")
            setOpen(false);
    ...
    return (
        <>
            <Modal title="Import danh sách vòng 2" open={open} cancelText="Bỏ qua" width={'800px'}
            ...
            >
                ...
                >
                    <Row gutter={16} justify='start'>
                        ...
                        <Col span={24}>
                            {
                                showErrorFile ? <a download="error-file.xlsx" href={'data:application/octet-stream;base64,' + showErrorFile}>Tải file lỗi</a>
...
export default ImportRegistrationRound2;
