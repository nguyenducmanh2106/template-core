...
interface Props {
    ...
    districtDepends: SelectOptionModel[],
    departmentEdit: DepartmentModel,
    setOpen: (value: boolean) => void;
    reload: (current: number, pageSize: number) => void;
}
const EditDepartment: React.FC<Props> = ({ open, setOpen, reload, provinces, departmentEdit, districtDepends }) => {
    ...
    const handleOk = async () => {
        ...
        const response = await putDepartment(departmentEdit.id as string, objBody);
    ...
    return (
        <>
            <Modal title="Cập nhật thông tin Sở giáo dục" open={open} okText={modalButtonOkText} cancelText="Bỏ qua" width={800}
            ...
            >
                <Form
                    ...
                    initialValues={{
                        ...
                        ["ProvinceId"]: departmentEdit?.provinceId ?? '',
                    }}
                >
