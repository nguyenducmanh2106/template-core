...
interface Props {
    open: boolean;
    recordEdit: ExamRegistrationScheduleModel,
    setOpen: (value: boolean) => void;
    reload: (current: number, pageSize: number) => void;
}
const ExamRegistrationScheduleEditTFC: React.FC<Props> = ({ open, setOpen, reload, recordEdit }) => {
    ...
    const handleOk = async () => {
        ...
        const arrayClone = [...examRegistrationSchedules];
        ...
        setExamRegistrationSchedules(arrayClone)
        setOpen(false);
            ...
            >
                <Form
                    ...
                    initialValues={{
                        ...
                        ["startDate"]: moment(recordEdit.startDate),
                        ["endDate"]: moment(recordEdit.endDate),
                        ["examDate"]: moment(recordEdit.examDate),
...
export default ExamRegistrationScheduleEditTFC;