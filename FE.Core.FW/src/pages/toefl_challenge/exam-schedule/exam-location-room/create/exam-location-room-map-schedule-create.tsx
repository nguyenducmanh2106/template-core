...
const ExamLocationRoomMapSchedule: React.FC<Props> = ({
    children,
    examSchedule,
    ...restProps
}) => {
    ...
    const [examLocationMapSchedules, setExamLocationMapSchedules] = useRecoilState<ExamLocationScheduleModel[]>(examLocationMapScheduleState);
    ...
    useEffect(() => {
        setData([])
        const examLocationMapScheduleOptions = ConvertOptionSelectModel(examLocationMapSchedules as OptionModel[]);
...
export default ExamLocationRoomMapSchedule
