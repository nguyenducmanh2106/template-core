      ...
      <CKEditor
        ...
        config={{
          ...
          toolbar: [
            ...
            'selectAll', 'undo', 'redo', 'link', '|', 'numberedList', 'bulletedList', 'indent', 'outdent', '|',
            'insertTable', 'tableColumn', 'tableRow', 'mergeTableCells', '|',
            'uploadImage',
            'imageTextAlternative', 'toggleImageCaption', 'imageStyle:inline', 'imageStyle:alignLeft', 'imageStyle:alignRight', 'imageStyle:alignCenter',
            'imageStyle:alignBlockLeft', 'imageStyle:alignBlockRight', 'imageStyle:block', 'imageStyle:side', 'imageStyle:wrapText', 'imageStyle:breakText',
            "|",
            'ckfinder', 'mediaEmbed',
          ],
