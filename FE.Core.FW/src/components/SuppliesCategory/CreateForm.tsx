...
interface CreateFormProps {
  ...
  onSubmitCreate: (values: Omit<SuppliesCategoryModel, 'id'>) => Promise<void>;
...
const CreateForm: React.FC<CreateFormProps> = props => {
  ...
  const formVals: Omit<SuppliesCategoryModel, 'id'> = {
    name: '',
    suppliesSerialStatus: 1,
    isActive: true,
    note: ''
  };
  ...
  return (
    ...
    >
      ...
      >
        ...
        >
          <Input placeholder='Nhập tên danh mục vật tư' maxLength={255} />
        </Form.Item>
        <Form.Item
